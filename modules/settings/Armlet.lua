local ArmletSettings = {}

ArmletSettings.RawDamageAbilityEstimation = {
...
ArmletSettings.armletDotTickTable = {
...
ArmletSettings.armletDotTickTableAOE = {
...
ArmletSettings.armletProjectileList = {
...
ArmletSettings.attackPointTable = {
...
function ArmletSettings:GetRawDamage()
	local Table = ArmletSettings.RawDamageAbilityEstimation
	return Table;
end

function ArmletSettings:GetDotTick()
	local Table = ArmletSettings.armletDotTickTable
	return Table;
end

function ArmletSettings:GetDotTickAOE()
	local Table = ArmletSettings.armletDotTickTableAOE
	return Table;
end

function ArmletSettings:GetProjectile()
	local Table = ArmletSettings.armletProjectileList
	return Table;
end

function ArmletSettings:GetAttackPoint()
	local Table = ArmletSettings.attackPointTable
	return Table;
end

return ArmletSettings